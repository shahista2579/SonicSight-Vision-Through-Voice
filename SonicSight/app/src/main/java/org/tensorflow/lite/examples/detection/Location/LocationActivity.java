...
public class LocationActivity extends AppCompatActivity {
    float x1, x2;
    public FusedLocationProviderClient fusedLocationClient;//One of the location APIs in google play services
    public static final int LOCATION_PERMISSION_REQUEST_CODE = 2;//Request Code is used to check which permission called this function. // This request code is provided when the user is prompt for permission.
    ...
    private void getAddress() {
        if (!Geocoder.isPresent()) {
            Toast.makeText(getApplicationContext(), "Can't find current address, ",
