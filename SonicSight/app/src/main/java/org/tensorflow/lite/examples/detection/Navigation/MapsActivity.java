...
public class MapsActivity extends FragmentActivity implements DirectionFinderListener {
    ...
    private void sendCallMap() {
        ...
        String transportationMode = getIntent().getStringExtra("transportationMode");
        try {

            String Urll = new DirectionFinder(this, origin, sessionId).createUrll();
            ...
            Uri gmmIntentUri = Uri.parse("google.navigation:q=" + Urll + "&mode=" + transportationMode);
