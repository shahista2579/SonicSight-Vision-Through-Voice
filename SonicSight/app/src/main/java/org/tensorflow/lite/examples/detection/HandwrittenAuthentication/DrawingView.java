...
/**
 * Main view for rendering content.The view accepts touch inputs, renders them on screen, and passes the content to the
...
public class DrawingView extends View implements StrokeManager.ContentChangedListener {
    ...
    public DrawingView(Context context, AttributeSet attributeSet) {
      ...
      dbHandler = new DBHandler(getContext());
        ...
        currentStrokePaint.setColor(Color.TRANSPARENT); // pink.
        ...
        recognizedStrokePaint.setColor(Color.TRANSPARENT); // pale pink.

        textPaint = new TextPaint();
        textPaint.setColor(Color.TRANSPARENT); // green.
