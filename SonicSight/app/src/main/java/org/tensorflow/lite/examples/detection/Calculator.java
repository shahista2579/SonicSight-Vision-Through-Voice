        ...
        textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    Toast.makeText(Calculator.this, "Opening the calculator......  just tap on the screen and say what you want to calculate. And Press the volume up button to return the main menu", Toast.LENGTH_SHORT).show();
        ...
        switch (requestCode) {
            case REQ_CODE_SPEECH_INPUT: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if (txtInput.getText().toString().contains("read")) {
                        Intent intent = new Intent(getApplicationContext(), OCRReader.class);
                        startActivity(intent);
                    } else if (txtInput.getText().toString().contains("weather")) {
                        Intent intent = new Intent(getApplicationContext(), Weather.class);
                        startActivity(intent);
                        txtInput.setText(null);
                    } else if (txtInput.getText().toString().contains("time and date")) {
                        Intent intent = new Intent(getApplicationContext(), DateAndTime.class);
                        startActivity(intent);
                    } else if (txtInput.getText().toString().contains("back")) {
                        Intent intent = new Intent(getApplicationContext(), Home.class);
                        startActivity(intent);
                    } else if (txtInput.getText().toString().contains("location")) {
                        Intent intent = new Intent(getApplicationContext(), LocationActivity.class);
                        startActivity(intent);
                        txtInput.setText(null);
                    } else if (txtInput.getText().toString().contains("battery")) {
                        Intent intent = new Intent(getApplicationContext(), Battery.class);
                        startActivity(intent);
                        txtInput.setText(null);
                    } else if (txtInput.getText().toString().contains("exit")) {
                        finish();
                        finishAffinity();
                        super.onPause();
                    } else {
